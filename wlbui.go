// wlbui project wlbui.go
//author:suirosu exgaya epowsal wlb
//email:iwlb@outlook.com exyaya@gmail.com
//create:20241022
/*
text defined ui;
can use to other go ui only need a special widget;
it can use to browser;
support widgets:
	label(multi,roll),
	edit(narrow),
	button,
	image(act view,slide),
	audio(control),
	video(control),
	2d(draw,view),
	3d(draw,view),
	...
	TreeTable(edit,view),
	HBox(edit,view),
	VBox(contain other,edit,view,simple webview),
	StackBox,
	Window,
	Dialog;
	NameCenter;
...
var IpCountryMap *treemap.Map[string, int]
...
func init() {
	...
	IpCountryMap = treemap.New[string, int]()
...
func IpToCountryId(ip string) int {
	_, fndval, bok := IpCountryMap.Floor(ip)
	if bok {
		return fndval
	}
	return 0
...
func GetAllParam(r *http.Request) string {
	var ret string = "{"
	var bfp bool = true
...
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):(e=e||self,function(){var n=e.Cookie,r=e.Cookie=t();r.noConflict=function(){return e.Cookie=n,r}}())}(this,function(){"use strict";var e={read:function(e){return e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)},write:function(e){return encodeURIComponent(e).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent)}};function t(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)e[r]=n[r]}return e}return function n(r,o){function i(e,n,i){if("undefined"!=typeof document){"number"==typeof(i=t({},o,i)).expires&&(i.expires=new Date(Date.now()+864e5*i.expires)),i.expires&&(i.expires=i.expires.toUTCString()),n=r.write(n,e),e=encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape);var c="";for(var u in i)i[u]&&(c+="; "+u,!0!==i[u]&&(c+="="+i[u].split(";")[0]));return document.cookie=e+"="+n+c}}return Object.create({set:i,get:function(t){if("undefined"!=typeof document&&(!arguments.length||t)){for(var n=document.cookie?document.cookie.split("; "):[],o={},i=0;i<n.length;i++){var c=n[i].split("="),u=c.slice(1).join("=");'"'===u[0]&&(u=u.slice(1,-1));try{var f=e.read(c[0]);if(o[f]=r.read(u,f),t===f)break}catch(e){}}return t?o[t]:o}},remove:function(e,n){i(e,"",t({},n,{expires:-1}))},withAttributes:function(e){return n(this.converter,t({},this.attributes,e))},withConverter:function(e){return n(t({},this.converter,e),this.attributes)}},{attributes:{value:Object.freeze(o)},converter:{value:Object.freeze(r)}})}(e,{path:"/"})});
`
	jstotal += selfjscode
	...
	/*
		regparam={};
		regparam.sessionid=Cookie.get('sessionid');
		post("/siteuser/api/cancel",regparam,function(ret){
			retar=JSON.parse(ret);
			if(retar.error==0){
...
xmlhttp.send(obj2urlparam(arg));}
	...
	if strings.Index(html, "postredi(") != -1 {
		jstotal += `
function postredi(to, p) {
...
#` + btn.id + `alignment:before {content: "Ali";}
#` + btn.id + `setTextColour:before {content: "Tco";}
#` + btn.id + `setHighlightColour:before {content: "Hco";}
#` + btn.id + `makeLink:before {content: "Mli";}
#` + btn.id + `fontColor:before {content: "Fco";}
#` + btn.id + `makeHeader:before {content: "Mhe";}
#` + btn.id + `makeUnorderedList:before {content: "Mul";}
#` + btn.id + `insertFile:before {content: "\Ifi";}
#` + btn.id + `undo:before {content: "Undo";}
#` + btn.id + `redo:before {content: "Redo";}
...
func NewTextArea(id, Class string, color []string, content string) *TextArea {
	return &TextArea{BaseBox: BaseBox{id: id, Class: Class, color: color, Maxheight: 20, Percentwidth: "99%", Percentheight: "100%", Hexpanding: 5, Vexpanding: 1, MinPercentwidth: "0%", MinPercentheight: "0%", MaxPercentwidth: "100%", MaxPercentheight: "100%", Float: "none", Display: "inline-block"}, content: content}
}
